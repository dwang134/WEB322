...
* 
*  Name: _Dylan Wang_ Student ID: _114099187_ Date: _11/12/2019_
*
*  Online (Heroku) URL: https://web3222a5.herokuapp.com/
*
********************************************************************************/
...
app.get('/departments', (req, res) => {
    ...
    .then((data) => {
        ...
        else res.render("departments",{message: ""})
    })
    .catch(() => res.render("departments",{"message": ""}))
})
